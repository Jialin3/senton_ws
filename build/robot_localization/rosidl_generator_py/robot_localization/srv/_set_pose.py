...
class Metaclass_SetPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from robot_localization.srv import _set_pose
...
class SetPose(metaclass=Metaclass_SetPose):
    from robot_localization.srv._set_pose import SetPose_Request as Request
    from robot_localization.srv._set_pose import SetPose_Response as Response
