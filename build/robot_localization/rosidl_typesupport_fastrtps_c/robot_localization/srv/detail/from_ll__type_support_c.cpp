...
#include "robot_localization/srv/detail/from_ll__rosidl_typesupport_fastrtps_c.h"
...
using _FromLL_Request__ros_msg_type = robot_localization__srv__FromLL_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _FromLL_Request__ros_msg_type * ros_message = static_cast<const _FromLL_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: ll_point
  {
  ...
  void * untyped_ros_message)
{
  ...
  _FromLL_Request__ros_msg_type * ros_message = static_cast<_FromLL_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: ll_point
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
{
  return max_serialized_size_robot_localization__srv__FromLL_Request(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_localization, srv, FromLL_Request)() {
...
using _FromLL_Response__ros_msg_type = robot_localization__srv__FromLL_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _FromLL_Response__ros_msg_type * ros_message = static_cast<const _FromLL_Response__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _FromLL_Response__ros_msg_type * ros_message = static_cast<_FromLL_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: map_point
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
{
  return max_serialized_size_robot_localization__srv__FromLL_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_localization, srv, FromLL_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_localization, srv, FromLL)() {
