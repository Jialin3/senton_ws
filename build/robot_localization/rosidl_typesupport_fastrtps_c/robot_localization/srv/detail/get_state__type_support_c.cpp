...
static size_t _GetState_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_robot_localization__srv__GetState_Request(
    full_bounded, 0);
}
...
static size_t _GetState_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_robot_localization__srv__GetState_Response(
    full_bounded, 0);
}
